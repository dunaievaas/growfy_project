...
/* harmony export */   "default": function() { return /* binding */ BlazeSlider; }
/* harmony export */ });
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (el) {
    new blaze_slider__WEBPACK_IMPORTED_MODULE_3__["default"](el, {
      all: {
        enableAutoplay: true,
  ...
  var slider = document.querySelectorAll('.blaze-slider-testimonials').forEach(function (slider) {
    new blaze_slider__WEBPACK_IMPORTED_MODULE_3__["default"](slider, {
      all: {
        slidesToShow: 3,
        slideGap: '48px'
      },
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()('.navbar-toggler').on('click', function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_2___default()(window).on('scroll', function (e) {
    if (window.scrollY > 0) {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('.header').addClass('scrolled');
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()('.header').removeClass('scrolled');
    }
  });
});
}();
